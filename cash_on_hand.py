...
def cash_on_hand_calculator():
    ...
    """
    This function will determine whether cash on hand is always increasing, decreasing, or fluctuating.
    ...
    #use elif to make sure the difference is always decreasing
        ...
        result.append([f"[HIGHEST CASH DEFICIT] DAY: {decreasing[0][0]}, AMOUNT: SGD{decreasing[0][1]}"])
